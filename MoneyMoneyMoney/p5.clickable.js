...
function Clickable() {
	...
	this.color = "#E0765C";		//Background color of the clickable
	this.cornerRadius = 0;		//Corner radius of the clickable
	this.strokeWeight = 3;		//Stroke width of the clickable
	this.stroke = "#000000";	//Border color of the clickable
	this.text = "Press Me";		//Text of the clickable
	this.textColor = "##DBE689";	//Color for the text shown
	this.textSize = 24;		//Size for the text shown
	this.textFont = "auster,sans-serif";	//Font for the text shown
