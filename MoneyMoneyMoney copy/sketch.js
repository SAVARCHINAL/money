// Grabbable garbage behavior:
// (1) they will be global variables since they appear in multiple rooms
// (2) they all start in MiniRoom1 and the avatar can drop them off in the landfill
// (3) once dropped off in landfill, they are no longer grabbable
// (4) they appear in landfill at dropped off coordinates
// (5) if you take them from the MiniRoom1 and run into a dollar sprite, they get deposited
//     back in MiniRoom1
...
preload() {
    ...
    this.npc1.addStandingAnimation('assets/stand1.png','assets/stand4.png');
    this.npc1.addSingleInteraction("In 2018 14.5 million tons were contributed to land fill as the hands of consumer culture. Bring trash to the landfill to clean the city.");
...
class Walkscreen2Room extends PNGRoom {
  preload() {
    this.npc2 = new NPC("celluser1", 1000, 500, 'grab/celluser1.png','grab/celluser2.png');
      ...
      this.npc4.addSingleInteraction("I cant belive they would ever post that");
      ...
      this.npc6.addSingleInteraction("I love Shein! Its so trendy theres no way its a sweatshop");
...
// class GameOverRoom extends PNGRoom {
// preload() {
//   this.npc8 = new NPC("girl", 700, 480, 'assets/move1.png','assets/move4.png');
//     this.npc8.addStandingAnimation('assets/move1.png','assets/move4.png');
//     this.npc8.addSingleInteraction("Press SPACE to drop trash");
//     this.hasSetup = false;
//   // define class varibles here, load images or anything else
// }
